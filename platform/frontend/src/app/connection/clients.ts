...
const WINDMILL_PATH =
  "M12 0L2.4 4.8v14.4L12 24l9.6-4.8V4.8L12 0zm0 2.4l7.2 3.6v12L12 21.6 4.8 18V6L12 2.4zM9.6 7.2v9.6l7.2-4.8-7.2-4.8z";
...
requires_openai_auth = true`,
  ...
  },
  {
    ...
    mcp: {
      ...
      supportedAuth: "both",
      preferredAuth: "token",
      configFile: "windmill workflow",
      language: "bash",
      steps: [
        {
          title: "Enable the Windmill MCP server",
          body: "Ensure your Windmill instance has the MCP server enabled and accessible.",
        },
        {
          title: "Paste the Endpoint",
          terminalTitle: "Endpoint",
        ...
        },
        {
          ...
          body: "Windmill supports both API tokens and OAuth. Use token for simplicity or configure OAuth for enhanced security.",
          showAuthHeader: true,
          authHeaderBare: true,
        },
        {
          title: "Verify tools load",
          body: "Confirm that Windmill tools like list_flows and update_flow appear in the tools panel.",
        },
      ],
    },
    proxy: {
